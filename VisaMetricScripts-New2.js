//https://cdn.jsdelivr.net/gh/farazloloei/public/VisaMetricScripts1.js
...
var correctPage = href.indexOf('Legalization');
alert('faraz');
if (correctPage != -1) {
...
correctPage = href.indexOf('appointment-form');

if (correctPage != -1) {
    
    console.info('start');
    
    var functionLoader = setTimeout(() => {
        console.info('run');
        var fr = $.ajax({
        ...
        if (fr.status == 200) { clearTimeout(functionLoader); }
    }, 500);
